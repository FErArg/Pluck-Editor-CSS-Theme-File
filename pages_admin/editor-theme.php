...
$temp2 = read_themes($site_theme);
//echo htmlentities($temp2);
// echo "/data/theme/". $site_theme ."/theme.php";
?>
<form method="post" action="">
			<label class="kop2" for="cont1"><?php echo $edit_edit_theme; ?></label>
			<br />
			<textarea name="cont1" id="cont1" cols="90" rows="20"><?php echo htmlentities($temp2); ?></textarea>
			<br />
